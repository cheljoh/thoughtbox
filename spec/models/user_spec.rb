...
RSpec.describe User, type: :model do
  ...
  it "confirms password and password confirmation" do
    user1 = User.create(email: "hi@cool.com", password: "hello", password_confirmation: "yo")
    expect(user1.valid?).to be false
    user2 = User.create(email: "sup@cool.com", password: "hello", password_confirmation: "hello")
